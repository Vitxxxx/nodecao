...
// Маршрут GET для получения всех данных
app.get('/api/users', (req, res) => {
  res.json(data);
});

// Динамический маршрут GET для фильтрации по марке автомобиля
app.get('/api/users/car/:carName', (req, res) => {
  const carName = req.params.carName;
  const filteredUsers = data.filter(user => user.car === carName);
  res.json(filteredUsers);
});

// Динамический маршрут GET для получения пользователя по ID
...
// Маршрут GET для получения всех электронных адресов
app.get('/api/emails', (req, res) => {
  const emails = data.map(user => user.email);
  res.json(emails);
});

// Маршрут GET для получения имен и фамилий всех женщин
